...
%pone la figura más linda
%exportfig(gcf,'performance2','Format','eps','Preview','none','Width',3.5,'Renderer','painters','Resolution',300,'FontMode','fixed','FontSize',10,'LineMode','fixed','LineWidth',1,'Color','cmyk')
